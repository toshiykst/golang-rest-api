...
// Source: app/usecase/repository/post_repository.go
...
import (
	...
	domain "github.com/toshiykst/golang-rest-api/app/domain"
	reflect "reflect"
)
...
func (m *MockPostRepository) FindPost(id int) (domain.Post, error) {
	m.ctrl.T.Helper()
...
func (m *MockPostRepository) CreatePost(arg0 *domain.Post) error {
	m.ctrl.T.Helper()
...
func (m *MockPostRepository) UpdatePost(arg0 *domain.Post) error {
	m.ctrl.T.Helper()
...
func (m *MockPostRepository) DeletePost(arg0 *domain.Post) error {
	m.ctrl.T.Helper()
...
func (m *MockPostRepository) FindPosts() (domain.Posts, error) {
	m.ctrl.T.Helper()
